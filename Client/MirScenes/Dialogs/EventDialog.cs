...
namespace Client.MirScenes.Dialogs
{
    public class EventDialog : MirImageControl
    {
        ...
        public EventDialog()
        {
            ...
            BeforeDraw += (o, e) =>
            {
                Libraries.Prguse2.Draw(35, Location.X, Location.Y);
                Libraries.Prguse2.Draw(36, Location.X, Location.Y);

                Libraries.Prguse2.Draw(37, new Rectangle(0, 0, (int)(completedPercentage* 2), 20), new Point(Location.X + 10, Location.Y + 364), Color.White, false);
        ...
        private void _progress_BeforeDraw(object sender, EventArgs e)
        {
            ...
            _progress.Library.DrawBlend(37, rect, _progress.DisplayLocation, Color.White, false);
        }
