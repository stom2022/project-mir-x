    ...
    public abstract class MapObject
    {
        ...
        public void DrawBossHealthBar()
        {
            ...
            if (this.Name.Contains("("))
                str = this.Name.Substring(this.Name.IndexOf("(") + 1, this.Name.Length - this.Name.IndexOf("(") - 2);
            if (this.Dead || this.Race != ObjectType.Monster)
                return;
            if (CMain.Time >= this.HealthTime && this.Race == ObjectType.Monster)
            {
                Client.MirObjects.MonsterObject monsterObject = (Client.MirObjects.MonsterObject)this;
                if (!monsterObject.IsBoss && !monsterObject.IsSub)
                    return;
            }
            Libraries.CustomPrguse.Draw(32, new Rectangle(0, 0, 324, 97), new Point(Settings.ScreenWidth / 2 - 158, 43), Color.White, false);
            Libraries.CustomPrguse.Draw(33, new Rectangle(0, 0, (int)((double)(231 * (int)this.PercentHealth) / 100.0), 12), new Point(Settings.ScreenWidth / 2 - 83, 84), Color.White, false);
            Libraries.CustomPrguse.Draw(34, new Rectangle(0, 0, (int)((double)(231 * (int)MapObject.User.PercentHealth) / 100.0), 12), new Point(Settings.ScreenWidth / 2 - 83, 102), Color.White, false);
            this.DrawBossName();
        }
        ...
        public void DrawBossImage()
        {
            ...
            {
                case 0:
                    Libraries.MobImage.Draw(152, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 11:
                    Libraries.MobImage.Draw(187, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 13:
                    Libraries.MobImage.Draw(230, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 14:
                    Libraries.MobImage.Draw(202, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 17:
                case 22:
                case 191:
                    Libraries.MobImage.Draw(219, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 20:
                    Libraries.MobImage.Draw(150, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 27:
                    Libraries.MobImage.Draw(208, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 30:
                    Libraries.MobImage.Draw(250, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 33:
                    Libraries.MobImage.Draw(156, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 34:
                    Libraries.MobImage.Draw(298, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 36:
                    Libraries.MobImage.Draw(284, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 37:
                    Libraries.MobImage.Draw(238, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 43:
                    Libraries.MobImage.Draw(282, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 50:
                    Libraries.MobImage.Draw(271, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 52:
                    Libraries.MobImage.Draw(182, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 71:
                    Libraries.MobImage.Draw(318, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 73:
                    Libraries.MobImage.Draw(318, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    ...
                    break;
                case 79:
                    Libraries.MobImage.Draw(307, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 84:
                case 121:
                    ...
                    break;
                case 88:
                    Libraries.MobImage.Draw(176, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 91:
                    Libraries.MobImage.Draw(152, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                ...
                case 96:
                    ...
                    break;
                case 107:
                    Libraries.MobImage.Draw(345, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 117:
                    Libraries.MobImage.Draw(152, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    ...
                    break;
                case 137:
                    Libraries.MobImage.Draw(278, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 164:
                    Libraries.MobImage.Draw(289, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 170:
                    Libraries.MobImage.Draw(154, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 182:
                    Libraries.MobImage.Draw(241, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 183:
                    Libraries.MobImage.Draw(221, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 189:
                    Libraries.MobImage.Draw(321, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 192:
                    Libraries.MobImage.Draw(219, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    ...
                    break;
                case 197:
                    Libraries.MobImage.Draw(311, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 232:
                    Libraries.MobImage.Draw(293, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 241:
                    Libraries.MobImage.Draw(172, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
                case 254:
                    Libraries.MobImage.Draw(270, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    Libraries.CustomPrguse.Draw(31, new Rectangle(0, 0, 550, 78), new Point(Settings.ScreenWidth / 2 - 132, 78), Color.White, false);
                    break;
